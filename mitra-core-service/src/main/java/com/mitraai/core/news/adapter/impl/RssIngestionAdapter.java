package com.mitraai.core.news.adapter.impl;

import com.mitraai.core.news.adapter.IngestionAdapter;
import com.mitraai.core.news.entity.NewsArticleEntity;
import com.mitraai.core.news.entity.NewsSource;
import com.mitraai.core.news.service.LocationResolver;
        ...
        try {
            ...
            for (SyndEntry entry : feed.getEntries()) {
                ...
                NewsArticleEntity article = NewsArticleEntity.builder()
                        ...
                        .country(source.getRegion()) // Pre-set country from source region (e.g. "India", "United Kingdom")
