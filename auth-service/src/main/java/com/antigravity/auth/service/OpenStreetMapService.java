...
public class OpenStreetMapService implements GeocodingService {
    ...
    public LocationData reverseGeocode(double latitude, double longitude) {
        try {
            ...
            headers.set(HttpHeaders.USER_AGENT, "Antigravity-Auth-Service/1.0"); // Nominatim requires User-Agent
            ...
            if (response.getBody() != null) {
                ...
                if (body.containsKey("address")) {
                    ...
                    String pincode = address.getOrDefault("postcode", "");

                    return new LocationData(village, taluk, district, state, pincode);
                }
            }
        } catch (Exception e) {
